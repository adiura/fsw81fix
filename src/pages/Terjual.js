						...
						<Col lg={3} className="">
							<Card className="cardMenuPenjual">
								<div className="kontenCardMenuPenjual">
									...
									<p>
										<a href="/daftar/product" className="icon2" style={{ margin: 7, padding: 7 }}>
											<ViewInArIcon />
									...
									<hr />
									<p>
										<a href="/minat" className="icon2" style={{ margin: 7, padding: 7 }}>
											<FavoriteBorderIcon /> Diminati <ChevronRightIcon />{' '}
										</a>
									</p>
									<hr />
									<p>
										<a href="/terjual" className="icon2" style={{ margin: 7, padding: 7 }}>
